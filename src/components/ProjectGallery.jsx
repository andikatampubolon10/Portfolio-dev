      ...
      <section ref={sectionRef} className="relative bg-neutral-900 overflow-hidden py-16 pb-20">
        ...
        <div className="px-6 mb-10">
          <div className="flex items-center gap-4 mb-10">
            <div className="w-2 h-2 bg-sky-400 rounded-full shadow-[0_0_8px_rgba(56,189,248,0.8)]" />
          ...
          <h2 className="text-5xl font-black text-white uppercase leading-[0.92] tracking-tight">
            Past<br />
            <span className="text-sky-400">Explorations</span>
          </h2>
        ...
        <div className="px-6 mb-6 flex items-center justify-between">
          ...
          <div className="flex gap-1.5">
            {projects.map((_, i) => (
              <div
                key={i}
                className={`h-1 rounded-full transition-all duration-300 ${i === activeProjectIndex ? 'w-6 bg-sky-400' : 'w-1.5 bg-white/20'}`}
              />
            ))}
          </div>
        </div>
      ...
      <div className="flex w-full h-[100dvh] items-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <ArrowUpRight className="text-sky-400 w-24 h-24 mt-8" />
          </Gsap.div>
          ...
          {projects.map((project, index) => (
            <Gsap.div
              ...
              className="project-card group relative h-[70vh] w-[45vw] shrink-0 overflow-hidden rounded-[4px] border border-white/10 bg-neutral-900 transition-all duration-500 hover:border-sky-400/50 hover:shadow-[0_0_40px_rgba(56,189,248,0.1)] active:scale-[0.98] cursor-pointer"
              data-project-index={index}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-10 flex flex-col justify-end translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out z-10">
                <div className="flex justify-between items-end gap-4">
                  ...
                  <div className="w-14 h-14 bg-white/10 border border-white/20 text-white flex items-center justify-center rounded-full shrink-0 group-hover:bg-sky-400 group-hover:text-black group-hover:border-sky-400 transition-all duration-300 shadow-lg">
              ...
              >
                <div className="flex items-start">
                  <span className="font-mono text-sm text-sky-400 font-bold mr-1 pt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500">NO.</span>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 z-10">
        {projects.map((_, index) => {
          ...
          return (
            <div
              key={index}
              className={`h-2 rounded-full transition-all duration-300 ${isActive ? 'w-8 bg-sky-400' : 'w-2 bg-white/30'}`}
            />
          );
        })}
      </div>
