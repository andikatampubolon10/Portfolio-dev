    ...
    return (
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[100] flex flex-col items-end pointer-events-auto font-mono text-sm">
            ...
            {isOpen && (
                <div className="mb-3 md:mb-4 w-[min(95vw,480px)] bg-[#0c0c0c] border border-neutral-800 shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-300 rounded-md">
                    ...
                    <div className="px-3 py-2 border-t border-neutral-800 bg-[#0c0c0c] flex gap-2 overflow-x-auto no-scrollbar">
                        <button onClick={() => quickAction("Tell me about your tech stack")} className="text-[10px] text-neutral-400 border border-neutral-700 px-2 py-0.5 rounded hover:border-sky-400 hover:text-sky-400 transition-colors whitespace-nowrap" aria-label="Ask about tech stack">./stack</button>
                        <button onClick={() => quickAction("Show me your projects")} className="text-[10px] text-neutral-400 border border-neutral-700 px-2 py-0.5 rounded hover:border-sky-400 hover:text-sky-400 transition-colors whitespace-nowrap" aria-label="Ask about projects">./projects</button>
                        <button onClick={() => quickAction("Tell me about your experience")} className="text-[10px] text-neutral-400 border border-neutral-700 px-2 py-0.5 rounded hover:border-sky-400 hover:text-sky-400 transition-colors whitespace-nowrap" aria-label="Ask about experience">./experience</button>
                        <button onClick={() => quickAction("How can I contact you?")} className="text-[10px] text-neutral-400 border border-neutral-700 px-2 py-0.5 rounded hover:border-sky-400 hover:text-sky-400 transition-colors whitespace-nowrap" aria-label="Ask about contact">./contact</button>
                    </div>

                    {/* Input Area */}
                    <form onSubmit={handleSendMessage} className="border-t border-neutral-800 bg-[#0c0c0c] p-2 flex gap-2 items-center">
                        <span className="text-sky-400 pl-2 select-none">{'>'}</span>
                        <input
                            ref={inputRef}
                            type="text"
                            value={inputValue}
                            ...
                            placeholder=""
                            className="flex-1 bg-transparent border-none outline-none text-sky-400 text-base font-mono caret-sky-400"
            ...
            <button
                ...
                className="group flex items-center justify-center w-11 h-11 md:w-14 md:h-14 bg-black border border-neutral-800 text-sky-400 shadow-lg hover:bg-neutral-900 transition-all rounded-full"
