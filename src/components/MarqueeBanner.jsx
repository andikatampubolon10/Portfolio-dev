...
const MarqueeBanner = memo(function MarqueeBanner() {
  return (
    <div className="relative z-20 sm:-rotate-[0.8deg] sm:scale-[1.02] cursor-default select-none">
      <div className="bg-black shadow-[0_0_40px_rgba(56,189,248,0.08)]">
              ...
              <div key={i} className="flex gap-6 md:gap-14 text-lg sm:text-2xl md:text-4xl font-black uppercase items-center">
                {skills.map((skill, j) => (
                  <span key={j} className="flex items-center gap-6 md:gap-14">
                    <span
                      className="text-sky-400 hover:text-white transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(56,189,248,0.6)]"
                    >
                      {skill}
                    </span>
        ...
        <div className="py-2.5 md:py-4 bg-sky-400 overflow-hidden relative group">
          <div
          ...
          {/* Edge Fades */}
          <div className="absolute inset-y-0 left-0 w-12 md:w-24 bg-gradient-to-r from-sky-400 to-transparent z-10 pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-12 md:w-24 bg-gradient-to-l from-sky-400 to-transparent z-10 pointer-events-none" />
        </div>
